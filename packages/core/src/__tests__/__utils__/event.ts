...
export function dispatchTouch(target: EventTarget, name = 'touchstart', touches: CustomTouches): void {
...
export function dispatchTouchStart(target: EventTarget, touches: CustomTouches): void {
  dispatchTouch(target, 'touchstart', touches);
}

export function dispatchTouchMove(target: EventTarget, touches: CustomTouches) {
  dispatchTouch(target, 'touchmove', touches);
}

export function dispatchTouchEnd(target: EventTarget, touches: CustomTouches) {
  dispatchTouch(target, 'touchend', touches);
}

export function dispatchSwipe(target: EventTarget, touches: CustomTouches, duration: number, cb: () => any): void {
