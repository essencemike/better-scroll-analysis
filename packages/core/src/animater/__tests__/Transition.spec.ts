...
jest.mock('@bsas/shared-utils/src/raf', () => {
  return {
...
describe('Transition', () => {
  ...
  it('should set timeFunction and trigger event', () => {
    ...
    transition.move(startPoint, endPoint, 200, 'cubic-bezier(0.23, 1, 0.32, 1)', false);

    expect(onTime).toHaveBeenCalledTimes(1);
    expect(onTimeFunction).toHaveBeenCalledTimes(1);
    expect(dom.style.webkitTransitionTimingFunction).toBe('cubic-bezier(0.23, 1, 0.32, 1)');
  ...
  it('should not trigger end hook with isSlient=true, time = 0', () => {
    ...
    transition.move(startPoint, endPoint, 200, 'cubic-bezier(0.23, 1, 0.32, 1)', true);
  ...
  it('should trigger end hook with isSlient=false,time=0', () => {
    ...
    transition.move(startPoint, endPoint, 0, 'cubic-bezier(0.23, 1, 0.32, 1)', false);
